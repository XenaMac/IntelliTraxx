...
namespace Base_AVL.Controllers
{
    ...
    public class AccountController : MessageControllerBase 
    {
        ...
        {
            if (Request.Browser.Type.ToUpper().Contains("INTERNETEXPLORER")) // replace with your check
            {
                ViewBag.Browser = "IE";
            } 
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if(userID.ToString() != "00000000-0000-0000-0000-000000000000")
            {
                ...
                this.AddToastMessage("Logon Successful", "Welcome to IntelliTruxx!", ToastType.Success);
                return RedirectToAction("Index", "VehicleLocation"); // auth succeed 
            } else {
