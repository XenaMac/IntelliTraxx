...
namespace IntelliTraxx.Common
{
    public static class Utilities
    {
        ...
        {
            var truckService = new TruckServiceClient();
            var users = truckService.getUsers(new Guid());
            var items = new List<SelectListItem>();
            foreach (var u in users)
                items.Add(new SelectListItem
                    {Text = u.UserFirstName + " " + u.UserLastName, Value = u.UserID.ToString()});
            return items;
        }
        ...
        {
            var truckService = new TruckServiceClient();
            var classes = truckService.getVehicleClasses();
            IList<SelectListItem> items = new List<SelectListItem>();
            foreach (var vc in classes)
